...
import com.example.blog.service.impl.MyDetailServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    @Autowired
    MyDetailServiceImpl userService;
...
/**
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/register").permitAll() //注册需要放行
                .antMatchers("/login").permitAll() //注册需要放行
                .antMatchers("/login_page","/currentUserName").permitAll()
